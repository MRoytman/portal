	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if("".compareToIgnoreCase(session.getAttribute("username").toString().trim())!=0)
        {
			...
			String realPath = getServletContext().getRealPath("/");
			 ...
			 if("f1".compareToIgnoreCase(folder)==0||"f2".compareToIgnoreCase(folder)==0||"f3".compareToIgnoreCase(folder)==0||"f4".compareToIgnoreCase(folder)==0||"f5".compareToIgnoreCase(folder)==0||"f6".compareToIgnoreCase(folder)==0||"f7".compareToIgnoreCase(folder)==0)
			 {
			 ...
			 if("f8".compareToIgnoreCase(folder)==0||"f9".compareToIgnoreCase(folder)==0||"f10".compareToIgnoreCase(folder)==0)
			 {
