...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles1=new File(session.getServletContext().getRealPath("/f5/Files_encounters/"));
	if (!dirEncounterFiles1.exists()) {
		dirEncounterFiles1.mkdirs();
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f5/Files_encounters/");
		 	String fileNameTypeDis1="EncounterSGBV_Main_medical_consultation-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterSGBV_Main_medical_consultation-FieldsLabel.txt";
		 	String strTitle="Main medical consultation";//read from encounterLabel.txt
		 	String xmlFileTypeDis1="<msf_typeEnDis1><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis1><File>";
		 	String xmlLableDis1="<msf_labelEnDis1>";
		 	String xmlTypeDis1="<msf_typeEnDis1>";
		 	String strCheck="encounter1";
            String language = "en";
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("SGBV_Main_medical_consultation")) {
                           isChecked = true;
                           break;
                       }
                   }
