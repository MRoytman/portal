...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f5/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f5/Files_encounters/");
		 	String fileNameTypeDis1="EncounterSGBV_FUP_medical_consultation-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterSGBV_FUP_medical_consultation-FieldsLabel.txt";
		 	String strTitle="Follow-up medical consultation";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("SGBV_FUP_medical_consultation")) {
                           isChecked = true;
                           break;
                       }
                   }
