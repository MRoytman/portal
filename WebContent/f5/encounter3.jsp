...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles3=new File(session.getServletContext().getRealPath("/f5/Files_encounters/"));
	if (!dirEncounterFiles3.exists()) {
		dirEncounterFiles3.mkdirs();
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f5/Files_encounters/");
		 	String fileNameTypeDis1="EncounterSGBV_Main_mental_health_consultation-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterSGBV_Main_mental_health_consultation-FieldsLabel.txt";
		 	String strTitle="Main mental health consultation";//read from encounterLabel.txt
		 	String xmlFileTypeDis1="<msf_typeEnDis3><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis3><File>";
		 	String xmlLableDis1="<msf_labelEnDis3>";
		 	String xmlTypeDis1="<msf_typeEnDis3>";
		 	String strCheck="encounter3";
            String language = "en";
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("SGBV_Main_mental_health_consultation")) {
                           isChecked = true;
                           break;
                       }
                   }
