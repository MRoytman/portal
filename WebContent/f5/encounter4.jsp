...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	//Attention: support 3 languages !!!

	File dirEncounterFiles4=new File(session.getServletContext().getRealPath("/f5/Files_encounters/"));
	if (!dirEncounterFiles4.exists()) {
		dirEncounterFiles4.mkdirs();
		out.print("First time: need to copy the resources.");
	}else{
			String encounterPath1 = session.getServletContext().getRealPath("/f5/Files_encounters/");
		 	String fileNameTypeDis1="EncounterSGBV_FUP_mental_health_consultation-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterSGBV_FUP_mental_health_consultation-FieldsLabel.txt";
		 	String strTitle="Follow-up mental health consultation";//read from encounterLabel.txt
		 	String xmlFileTypeDis1="<msf_typeEnDis4><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis4><File>";
		 	String xmlLableDis1="<msf_labelEnDis4>";
		 	String xmlTypeDis1="<msf_typeEnDis4>";
		 	String strCheck="encounter4";
            String language = "en";
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("SGBV_FUP_mental_health_consultation")) {
                           isChecked = true;
                           break;
                       }
                   }
