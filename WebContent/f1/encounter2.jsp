...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f1/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f1/Files_encounters/");
		 	String fileNameTypeDis1="EncounterMeasles_malaria_severe-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterMeasles_malaria_severe-FieldsLabel.txt";
		 	String strTitle="IPD - Malaria/measles";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
	               ...
	               while((strLine = bufferedReader.readLine())!= null){
	                   if (strLine.contains("Measles_malaria_severe")) {
	                       isChecked = true;
	                       break;
	                   }
	               }
