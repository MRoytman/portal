...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles5=new File(session.getServletContext().getRealPath("/f1/Files_encounters/"));
	if (!dirEncounterFiles5.exists()) {
		dirEncounterFiles5.mkdirs();
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f1/Files_encounters/");
		 	String fileNameTypeDis1="EncounterCholera_CTC-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterCholera_CTC-FieldsLabel.txt";
		 	String strTitle="Cholera CTU";//read from encounterLabel.txt
		 	String xmlFileTypeDis1="<msf_typeEnDis5><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis5><File>";
		 	String xmlLableDis1="<msf_labelEnDis5>";
		 	String xmlTypeDis1="<msf_typeEnDis5>";
		 	String strCheck="encounter5";
		 	String language = "en";
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
	               ...
	               while((strLine = bufferedReader.readLine()) != null){
	                   if (strLine.contains("Cholera_CTC")) {
	                       isChecked = true;
	                       break;
	                   }
	               }
