...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles3=new File(session.getServletContext().getRealPath("/f1/Files_encounters/"));
	if (!dirEncounterFiles3.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f1/Files_encounters/");
		 	String fileNameTypeDis1="EncounterYellow_Fever_Case-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterYellow_Fever_Case-FieldsLabel.txt";
		 	String strTitle="IPD - Yellow fever";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
	               ...
	               while((strLine = bufferedReader.readLine())!= null){
	                   if (strLine.contains("Yellow_Fever_Case")) {
	                       isChecked = true;
	                       break;
	                   }
	               }
