...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles4=new File(session.getServletContext().getRealPath("/f1/Files_encounters/"));
	if (!dirEncounterFiles4.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f1/Files_encounters/");
		 	String fileNameTypeDis1="EncounterCholera_ORS-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterCholera_ORS-FieldsLabel.txt";
		 	String strTitle="Cholera ORS";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
	               ...
	               while((strLine = bufferedReader.readLine())!= null){
	                   if (strLine.contains("Cholera_ORS")) {
	                       isChecked = true;
	                       break;
	                   }
	               }
