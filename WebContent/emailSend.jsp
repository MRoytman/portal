    ...
    <form action="SendMailAttachServlet" method="post" enctype="multipart/form-data">
        <table border="0" width="60%" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="recipient" <%-- value="<%= recipient%>" --%> size="50"/>
                 <br>(for testing only, will be set to dsi-support.gva@geneva.msf.org once validated)</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Content:</td>
                <td><textarea rows="12" cols="73" name="content"><%-- <%= content%> --%></textarea> </td>
            </tr>
            <tr>
