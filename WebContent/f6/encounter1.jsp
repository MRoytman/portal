...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles1=new File(session.getServletContext().getRealPath("/f6/Files_encounters/"));
	if (!dirEncounterFiles1.exists()) {
		dirEncounterFiles1.mkdirs();
		out.print("First time: need to copy the resources.");
	}else{
			String encounterPath1 = session.getServletContext().getRealPath("/f6/Files_encounters/");
		 	String fileNameTypeDis1="Encounteratfc-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounteratfc-FieldsLabel.txt";
		 	String strTitle="ATFC";//read from encounterLabel.txt
