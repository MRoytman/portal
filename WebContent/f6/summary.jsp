...
<center><h2>Summary of selected fields</h2></center>
 <%
	...
	if (!dirMasterFile.exists()) {
		...
		String ss1="ATFC";
		String ss2="ITFC";
		String ss3="Paediatrics";

		
 		String fileName0=jspPath+"/Patient-FieldsLabel.txt";
		String fileName1=jspPath+"/Encounteratfc-FieldsLabel.txt";
		String fileName2=jspPath+"/Encounteritfc-FieldsLabel.txt";
		String fileName3=jspPath+"/Encounterpaediatrics-FieldsLabel.txt";
...
%>
	...
	<table>
		<tr>
			<td><a href="./f6.jsp"><input type="button" value="Back"></a>
			</td>
			<td>
				<form action="../waiting.jsp" id="newJar" name="newJar"
					method="post">
