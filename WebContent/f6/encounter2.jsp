...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f6/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f6/Files_encounters/");
		 	String fileNameTypeDis1="Encounteritfc-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounteritfc-FieldsLabel.txt";
