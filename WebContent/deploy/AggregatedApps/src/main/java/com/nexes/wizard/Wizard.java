...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
	...
	public void setCurrentPanel(Object id, boolean myDirection) {
		...
		} catch (StopNextException e) { 
			// rollback next and stay on same panel
			id = e._DescriptorIdentifier;
		}
	...
	static {
		try {
			...
			// CANCEL_ICON = new ImageIcon((URL) getImage((String)
			// (resources.getObject("cancelButtonIcon")), Wizard.class));
	...
	// public void addCheckBusinessRules(
	// CheckBusinessRulesChecker checkBusinessRulesChecker) {
	//
	// _CheckBusinessRulesChecker = checkBusinessRulesChecker;
	// }
