...
//    public static final String CANCEL_BUTTON_TEXT_PROPERTY = "cancelButtonTextProperty";
    public static final String QUIT_BUTTON_TEXT_PROPERTY = "cancelButtonTextProperty";
    /**
...
//        return buttonTextHashmap.get(QUIT_BUTTON_TEXT_PROPERTY);
//    }
    
    void setQuitButtonText(Object newText) {
        
//        Object oldText = getCancelButtonText();
        Object oldText = buttonTextHashmap.get(QUIT_BUTTON_TEXT_PROPERTY);
        if (!newText.equals(oldText)) {
            buttonTextHashmap.put(QUIT_BUTTON_TEXT_PROPERTY, newText);
            firePropertyChange(QUIT_BUTTON_TEXT_PROPERTY, oldText, newText);
        }
    } 
