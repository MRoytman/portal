...
public class ExportCSVf5 {
	
	String atFolder="/ch/msf/fields/f5/";
	private String strFilePat = "Patient-FieldsIdType.txt";
	private String strFileEn1 = "EncounterSGBV_Main_medical_consultation-FieldsIdType.txt";
	private String strFileEn2 = "EncounterSGBV_FUP_medical_consultation-FieldsIdType.txt";
	private String strFileEn3 = "EncounterSGBV_Main_mental_health_consultation-FieldsIdType.txt";
	private String strFileEn4 = "EncounterSGBV_FUP_mental_health_consultation-FieldsIdType.txt";
		...
		try {
			...
			for (int i = 0; i < lstPatientDB.size(); i++) {
				...
				for (int j = 0; j < lstContextDB.size(); j++) {
					...
					valPrintEn1Detail=valPrintEn2Detail=valPrintEn3Detail=valPrintEn4Detail=null;
					writer.append('\n');
				}
			}
