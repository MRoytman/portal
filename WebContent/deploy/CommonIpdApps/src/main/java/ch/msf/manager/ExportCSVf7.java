...
public class ExportCSVf7 {
	
	String atFolder="/ch/msf/fields/f7/";
	private String strFilePat = "Patient-FieldsIdType.txt";
	private String strFileEn1 = "EncounterHIV_main_form-FieldsIdType.txt";
	private String strFileEn2 = "EncounterHIV_follow_up-FieldsIdType.txt";
	private String strFileEn3 = "EncounterTB-FieldsIdType.txt";
		...
		try {
			...
			for (int i = 0; i < lstPatientDB.size(); i++) {
				...
				for (int j = 0; j < lstContextDB.size(); j++) {
					...
					valPrintEn1Detail=valPrintEn2Detail=valPrintEn3Detail=null;
					writer.append('\n');
				}
			}
