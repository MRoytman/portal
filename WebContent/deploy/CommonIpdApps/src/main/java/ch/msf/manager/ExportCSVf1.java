...
public class ExportCSVf1 {
	...
	List<String> strCodeFullPat = rf.readFile(strFilePat);
	List<String> strCodeFullEn1 = rf.readFile(strFileEn1);
	List<String> strCodeFullEn2 = rf.readFile(strFileEn2);
	List<String> strCodeFullEn3 = rf.readFile(strFileEn3);
	List<String> strCodeFullEn4 = rf.readFile(strFileEn4);
	List<String> strCodeFullEn5 = rf.readFile(strFileEn5);
