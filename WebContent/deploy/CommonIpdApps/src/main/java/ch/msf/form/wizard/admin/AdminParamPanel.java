...
public class AdminParamPanel extends AbstractWizardPanel implements ActionListener, ListSelectionListener, ListDeleteListener, ListRenameListener, ListAddListener {
