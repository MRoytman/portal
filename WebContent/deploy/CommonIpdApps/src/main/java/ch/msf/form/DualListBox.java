...
public class DualListBox extends JPanel {
	...
	private AbstractWizardPanel _AdminParamCountriesPanel;
	...
	private void initScreen() {
		...
		add(destLabel, new GridBagConstraints(2, 0, 1, 1, 0, 0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE,
				EMPTY_INSETS, 0, 0));
		add(new JScrollPane(destList), new GridBagConstraints(2, 1, 1, 5, 1.0,
				1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				EMPTY_INSETS, 0, 0));
	}
	...
	public class AddListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			// CM wake up the listener
			_AdminParamCountriesPanel.actionPerformed(e);
		}
	}

	public class RemoveListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			ActionEventRetCode myActionEvent = new ActionEventRetCode(e);
			// CM wake up the listener
			// myActionEvent has been potentially modified
			_AdminParamCountriesPanel.actionPerformed(myActionEvent);
			if (myActionEvent.getRetCode() != CommonIpdConstants.EVENT_STOP_ACTION){
				Object selected[] = destList.getSelectedValues();
	...
	public void addActionListener(AbstractWizardPanel adminParamCountriesPanel) {
		// make it verrrryyy simple as we have only one listener in this implementation
		_AdminParamCountriesPanel = adminParamCountriesPanel;
	}
}
