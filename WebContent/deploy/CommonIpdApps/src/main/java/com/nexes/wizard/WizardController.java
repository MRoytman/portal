...
public class WizardController implements ActionListener {
    ...
    private void nextButtonPressed() {
        ...
        if (nextPanelDescriptor instanceof WizardPanelDescriptor.FinishIdentifier) {
        	// my code // CM     wizard.close(Wizard.FINISH_RETURN_CODE);
        } else {        
//            wizard.setCurrentPanel(nextPanelDescriptor);
            boolean myforward = true; // my code // CM
            wizard.setCurrentPanel(nextPanelDescriptor, myforward);
        }
    ...
    private void backButtonPressed() {
        ...
        boolean myforward = false; // my code // CM
        wizard.setCurrentPanel(backPanelDescriptor, myforward);
    ...
    void resetButtonsToPanelRules() {
        ...
        model.setQuitButtonText(Wizard.FINISH_TEXT);//use quit instead of change
        model.setCancelButtonIcon(Wizard.FINISH_ICON);
        ...
        if (descriptor.getNextPanelDescriptor() instanceof WizardPanelDescriptor.FinishIdentifier) {
        	// my code // CM: simple disable the next button
        	model.setNextFinishButtonEnabled(false);
...
//            model.setNextFinishButtonIcon(Wizard.NEXT_ICON);
        	// my code // CM: simple enable the next button and keep the same text and icon
        	model.setNextFinishButtonEnabled(true);
        }
