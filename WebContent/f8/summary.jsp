 ...
 <%
    ...
    if (!dirMasterFile.exists()) {
        ...
        out.print("First time: need to copy the resources.");
             ...
             String fileName0=jspPath+"/AggregatedTheme-phc-SectionLabels.txt";
...
<table>
    <tr>
        <td><a href="./f8.jsp"><input type="button" value="Back"></a>
        </td>
        <td>
        ...
        <td>
            <form action="../WritePDFServlet" method="post">
                <input type="hidden" name="pathPDF" value="/deployf8/resources/">
