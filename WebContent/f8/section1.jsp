...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	String sectionTmp1 = session.getServletContext().getRealPath("/f8/Files_sections/");
	...
	if (!dirSectionFiles1.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String sectionPath1 = session.getServletContext().getRealPath("/f8/Files_sections/");
		 	String fileNameId="Section-opd_parameters-TablesIds.txt";
		 	String fileNameTitle="Section-opd_parameters-TablesLabels.txt";
		 	String strTitle="General parameters";
