...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	String sectionTmp2 = session.getServletContext().getRealPath("/f8/Files_sections/");
	...
	if (!dirSectionFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String sectionPath1 = session.getServletContext().getRealPath("/f8/Files_sections/");
		 	String fileNameId="Section-opd_morbidity-TablesIds.txt";
		 	String fileNameTitle="Section-opd_morbidity-TablesLabels.txt";

		 	String strTitle="Morbidity";//read from encounterLabel.txt
