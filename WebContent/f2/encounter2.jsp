...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f2/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f2/Files_encounters/");
		 	String fileNameTypeDis1="Encountermental_health_fup-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encountermental_health_fup-FieldsLabel.txt";
		 	String strTitle="Mental health - Follow-up";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("mental_health_fup")) {
                           isChecked = true;
                           break;
                       }
                   }
