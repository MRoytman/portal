...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles1=new File(session.getServletContext().getRealPath("/f2/Files_encounters/"));
	if (!dirEncounterFiles1.exists()) {
		dirEncounterFiles1.mkdirs();
		out.print("First time: need to copy the resources.");
	}else{
			String encounterPath1 = session.getServletContext().getRealPath("/f2/Files_encounters/");
		 	String fileNameTypeDis1="Encountermental_health_main_assessment-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encountermental_health_main_assessment-FieldsLabel.txt";
		 	String strTitle="Mental health - Baseline consultation";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("mental_health_main_assessment")) {
                           isChecked = true;
                           break;
                       }
                   }
