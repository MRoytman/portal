...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f4/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f4/Files_encounters/");
		 	String fileNameTypeDis1="Encounterncd_fup-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounterncd_fup-FieldsLabel.txt";
		 	String strTitle="Follow";//read from encounterLabel.txt
