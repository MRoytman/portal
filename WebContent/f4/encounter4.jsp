...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles4=new File(session.getServletContext().getRealPath("/f4/Files_encounters/"));
	if (!dirEncounterFiles4.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f4/Files_encounters/");
		 	String fileNameTypeDis1="Encounterncd_exit-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounterncd_exit-FieldsLabel.txt";
		 	String strTitle="Exit";//read from encounterLabel.txt
