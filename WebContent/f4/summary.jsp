 ...
 <%
	...
	if (!dirMasterFile.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String ss1="Baseline";
			String ss2="Follow";
			String ss3="Investigation";
			String ss4="Exit";
			
			String fileName0=jspPath+"/Patient-FieldsLabel.txt";
			String fileName1=jspPath+"/Encounterncd_baseline-FieldsLabel.txt";
			String fileName2=jspPath+"/Encounterncd_fup-FieldsLabel.txt";
			String fileName3=jspPath+"/Encounterncd_tests_results-FieldsLabel.txt";
			String fileName4=jspPath+"/Encounterncd_exit-FieldsLabel.txt";
...
<table>
	<tr>
		<td><a href="./f4.jsp"><input type="button" value="Back"></a>
		</td>
		<td>
		...
		<td>
			<form action="../WritePDFServlet" method="post">
				<input type="hidden" name="pathPDF" value="/deployf4/resources/">
