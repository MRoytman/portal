...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <%
    String patientPath = session.getServletContext().getRealPath("/f4/Files_patients/");
