...
<center><h2>Summary of selected fields</h2></center>
 <%
    ...
    if (!dirMasterFile.exists()) {
        ...
        String ss0="Patient";
        String ss1="HIV Main Form";
        String ss2="HIV Follow Up";
        String ss3="TB";



         String fileName0=jspPath+"/Patient-FieldsLabel.txt";
        String fileName1=jspPath+"/EncounterHIV_main_form-FieldsLabel.txt";
        String fileName2=jspPath+"/EncounterHIV_follow_up-FieldsLabel.txt";
        String fileName3=jspPath+"/EncounterTB-FieldsLabel.txt";
...
<table>
    <tr>
        <td><a href="./f7.jsp"><input type="button" value="Back"></a>
        </td>
        <td>
        ...
        <td>
            <form action="../WritePDFServlet" method="post">
                <input type="hidden" name="pathPDF" value="/deployf7/resources/">
