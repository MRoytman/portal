...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles3=new File(session.getServletContext().getRealPath("/f7/Files_encounters/"));
	if (!dirEncounterFiles3.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f7/Files_encounters/");
		 	String fileNameTypeDis1="EncounterTB-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterTB-FieldsLabel.txt";
		 	String strTitle="TB";//read from encounterLabel.txt
