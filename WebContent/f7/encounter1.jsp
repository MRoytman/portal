...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles1=new File(session.getServletContext().getRealPath("/f7/Files_encounters/"));
	if (!dirEncounterFiles1.exists()) {
		dirEncounterFiles1.mkdirs();
		out.print("First time: need to copy the resources.");
	}else{
			String encounterPath1 = session.getServletContext().getRealPath("/f7/Files_encounters/");
		 	String fileNameTypeDis1="EncounterHIV_main_form-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterHIV_main_form-FieldsLabel.txt";
		 	String strTitle="HIV Main Form";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("HIV_main_form")) {
                           isChecked = true;
                           break;
                       }
                   }
