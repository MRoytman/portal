...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles2=new File(session.getServletContext().getRealPath("/f7/Files_encounters/"));
	if (!dirEncounterFiles2.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f7/Files_encounters/");
		 	String fileNameTypeDis1="EncounterHIV_follow_up-FieldsIdType.txt";
		 	String fileNameLabelDis1="EncounterHIV_follow_up-FieldsLabel.txt";
		 	String strTitle="HIV Follow Up";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("HIV_follow_up")) {
                           isChecked = true;
                           break;
                       }
                   }
