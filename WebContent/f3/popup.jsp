  	...
  	function setLstParam()
  	{
		...
		for (var i=0; i<document.newForm.msf_checked.length; i++)
		{
			...
			if(!ch.checked){
				...
				param=param.replace("<msf_labelEnDis4>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_typeEnDis4>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_labelEnDis5>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_typeEnDis5>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_labelEnDis6>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_typeEnDis6>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_labelEnDis7>"+ch.value+"<msf_split>", "");
				param=param.replace("<msf_typeEnDis7>"+ch.value+"<msf_split>", "");
