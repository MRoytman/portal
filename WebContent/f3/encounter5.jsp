...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles5=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles5.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encounterabortion-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounterabortion-FieldsLabel.txt";
		 	String strTitle="Abortion";//read from encounterLabel.txt
