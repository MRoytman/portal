...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles6=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles6.exists()) {
		dirEncounterFiles6.mkdirs();
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encounteremergency_room-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounteremergency_room-FieldsLabel.txt";
		 	String strTitle="Emergency Room";//read from encounterLabel.t
		 	String xmlFileTypeDis1="<msf_typeEnDis6><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis6><File>";
		 	String xmlLableDis1="<msf_labelEnDis6>";
		 	String xmlTypeDis1="<msf_typeEnDis6>";
		 	String strCheck="encounter6";
		    String language = "en";
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("emergency_room")) {
                           isChecked = true;
                           break;
                       }
                   }
