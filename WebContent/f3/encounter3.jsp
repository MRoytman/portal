...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles3=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles3.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encountermedicine-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encountermedicine-FieldsLabel.txt";
		 	String strTitle="Medicine";//read from encounterLabel.txt
