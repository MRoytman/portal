...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles1=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles1.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encounterneonatology-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounterneonatology-FieldsLabel.txt";
		 	String strTitle="Neonatology";//read from encounterLabel.txt
           ...
           if(dirResources != null && dirResources.length() != 0){// Edit form
               ...
               if(file.exists()){
                   ...
                   while((strLine = bufferedReader.readLine())!= null){
                       if (strLine.contains("neonatology")) {
                           isChecked = true;
                           break;
                       }
                   }
