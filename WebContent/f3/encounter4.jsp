...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles4=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles4.exists()) {
		...
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encounterdelivery-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encounterdelivery-FieldsLabel.txt";
		 	String strTitle="Delivery";//read from encounterLabel.txt
