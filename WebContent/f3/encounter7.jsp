...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <%
	...
	File dirEncounterFiles7=new File(session.getServletContext().getRealPath("/f3/Files_encounters/"));
	if (!dirEncounterFiles7.exists()) {
		dirEncounterFiles7.mkdirs();
		out.print("First time: need to copy the resources.");
			...
			String encounterPath1 = session.getServletContext().getRealPath("/f3/Files_encounters/");
		 	String fileNameTypeDis1="Encountersurgery-FieldsIdType.txt";
		 	String fileNameLabelDis1="Encountersurgery-FieldsLabel.txt";
		 	String strTitle="Surgery";//read from encounterLabel.txt
		 	String xmlFileTypeDis1="<msf_typeEnDis7><File>";
		 	String xmlFileLabelDis1="<msf_labelEnDis7><File>";
		 	String xmlLableDis1="<msf_labelEnDis7>";
		 	String xmlTypeDis1="<msf_typeEnDis7>";
		 	String strCheck="encounter7";
		    String language = "en";
